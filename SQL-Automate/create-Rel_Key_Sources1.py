...
cursor.execute('CREATE TABLE Rel_Keys_Sources (Key_ID varchar(200), Source_ID varchar(20), Rel_Type varchar(100), Rel_PK_ID varchar(20));')
...
record = session.run('MATCH ()-[r]-() where exists (r.source) UNWIND keys(r) as kl RETURN kl as key, r.uuid as uuid, r.source as src, type(r) as typ')
