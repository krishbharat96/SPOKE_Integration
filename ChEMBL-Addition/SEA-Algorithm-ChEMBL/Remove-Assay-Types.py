# Certain Assay types are not processed by the SEA algorithm.
# Created a dictionary (below) that contains these Assay Types
...
# Code to only include the Assays that can be read by SEA
